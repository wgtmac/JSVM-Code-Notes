...
protected:
  ...
  PicBufferList                     m_acOrgPicBufferList[MAX_LAYERS];                  // 编码器使用的 原始图像 list
  PicBufferList                     m_acRecPicBufferList[MAX_LAYERS];                  // 编码器使用的 重建图像 list
...
protected:
  ...
  AccessUnitDataList                m_cAccessUnitDataList;               //  用来存放 SVC编码器 的 AU

...
private:
  Bool    m_bDecRefBasePicMarking;                        //slice_header_in_scalable_extension( )中的dec_ref_base_pic_marking( ) ?????
  Bool    m_bAdaptiveRefPicMarkingModeFlag;       //slice_header( )中的dec_ref_pic_marking( )
};
...
private:
  Bool  m_bInterLayerParameters;                //指示是slice_header( )还是 slice_header_in_scalable_extension( )
  UInt  m_uiDisableDeblockingFilterIdc;      //slice_header( )          slice_header_in_scalable_extension( )
  Int   m_iSliceAlphaC0OffsetDiv2;              //slice_header( )         slice_header_in_scalable_extension( )
  Int   m_iSliceBetaOffsetDiv2;                     //slice_header( )         slice_header_in_scalable_extension( )
};
...
protected:
  Bool              m_bStoreRefBasePicFlag;                       //prefix_nal_unit_svc( )
  DecRefPicMarking  m_cDecRefBasePicMarking;       //dec_ref_base_pic_marking( )
private:
  Bool              m_bPrefixNalUnitAdditionalExtensionFlag;                //prefix_nal_unit_svc( ) d的 additional_prefix_nal_unit_extension_flag
};
...
private:
  //===== syntax =====
  UInt                        m_uiFirstMbInSlice;            //slice_header( )            slice_header_in_scalable_extension( )
  SliceType                   m_eSliceType;                  //slice_header( )            slice_header_in_scalable_extension( )
  UInt                        m_uiPicParameterSetId;     //slice_header( )            slice_header_in_scalable_extension( )
  UInt                        m_uiColourPlaneId;             //slice_header( )            slice_header_in_scalable_extension( )
  UInt                        m_uiFrameNum;                  //slice_header( )            slice_header_in_scalable_extension( )
  Bool                        m_bFieldPicFlag;                //slice_header( )            slice_header_in_scalable_extension( )
  Bool                        m_bBottomFieldFlag;         //slice_header( )            slice_header_in_scalable_extension( )
  UInt                        m_uiIdrPicId;                        //slice_header( )            slice_header_in_scalable_extension( )
  UInt                        m_uiPicOrderCntLsb;          //slice_header( )            slice_header_in_scalable_extension( )
  Int                         m_iDeltaPicOrderCntBottom;          //slice_header( )            slice_header_in_scalable_extension( )
  Int                         m_iDeltaPicOrderCnt0;           //slice_header( )            slice_header_in_scalable_extension( )
  Int                         m_iDeltaPicOrderCnt1;           //slice_header( )            slice_header_in_scalable_extension( )
  UInt                        m_uiRedundantPicCnt;        //slice_header( )            slice_header_in_scalable_extension( )
  Bool                        m_bDirectSpatialMvPredFlag;        //slice_header( )            slice_header_in_scalable_extension( )
  Bool                        m_bNumRefIdxActiveOverrideFlag;          //slice_header( )            slice_header_in_scalable_extension( )
  UInt                        m_uiNumRefIdxL0ActiveMinus1;                //slice_header( )            slice_header_in_scalable_extension( )
  UInt                        m_uiNumRefIdxL1ActiveMinus1;                //slice_header( )            slice_header_in_scalable_extension( )
  RefPicListReOrdering        m_cRefPicListReorderingL0;         //slice_header( )中的ref_pic_list_modification( )            slice_header_in_scalable_extension( )
  RefPicListReOrdering        m_cRefPicListReorderingL1;         //slice_header( )中的ref_pic_list_modification( )            slice_header_in_scalable_extension( )
  Bool                        m_bBasePredWeightTableFlag;                 //slice_header_in_scalable_extension( )
  UInt                        m_uiLumaLog2WeightDenom;                //slice_header( )中的pred_weight_table( )            slice_header_in_scalable_extension( )
  UInt                        m_uiChromaLog2WeightDenom;            //slice_header( )中的pred_weight_table( )            slice_header_in_scalable_extension( )
  PredWeightTable             m_cPredWeightTableL0;                //slice_header( )中的pred_weight_table( )            slice_header_in_scalable_extension( )   
  PredWeightTable             m_cPredWeightTableL1;                //slice_header( )中的pred_weight_table( )            slice_header_in_scalable_extension( )
  Bool                        m_bNoOutputOfPriorPicsFlag;                //slice_header( )中的dec_ref_pic_marking( )            slice_header_in_scalable_extension( )
  Bool                        m_bLongTermReferenceFlag;                   //slice_header( )中的dec_ref_pic_marking( )            slice_header_in_scalable_extension( )
  DecRefPicMarking            m_cDecRefPicMarking;                //slice_header( )中的dec_ref_pic_marking( )            slice_header_in_scalable_extension( )
  UInt                        m_uiCabacInitIdc;                                       //slice_header( )            slice_header_in_scalable_extension( )
  Int                         m_iSliceQpDelta;                                          //slice_header( )            slice_header_in_scalable_extension( )
  Bool                        m_bSPForSwitchFlag;                                //slice_header( )
  Int                         m_iSliceQsDelta;                                           //slice_header( )
  DBFilterParameter           m_cDeblockingFilterParameter;    //slice_header( )
  UInt                        m_uiSliceGroupChangeCycle;                     //slice_header( )            slice_header_in_scalable_extension( )
  UInt                        m_uiRefLayerDQId;                                        //slice_header_in_scalable_extension( )
  DBFilterParameter           m_cInterLayerDeblockingFilterParameter;    //slice_header_in_scalable_extension( )
  Bool                        m_bConstrainedIntraResamplingFlag;                     //slice_header_in_scalable_extension( )
  Bool                        m_bRefLayerChromaPhaseXPlus1Flag;                    //slice_header_in_scalable_extension( )
  UInt                        m_uiRefLayerChromaPhaseYPlus1;                           //slice_header_in_scalable_extension( )
  Int                         m_iScaledRefLayerLeftOffset;                                      //slice_header_in_scalable_extension( )
  Int                         m_iScaledRefLayerTopOffset;                                      //slice_header_in_scalable_extension( )
  Int                         m_iScaledRefLayerRightOffset;                                    //slice_header_in_scalable_extension( )
  Int                         m_iScaledRefLayerBottomOffset;                                //slice_header_in_scalable_extension( )
  Bool                        m_bSliceSkipFlag;                                                        //slice_header_in_scalable_extension( )
  UInt                        m_uiNumMbsInSliceMinus1;                                      //slice_header_in_scalable_extension( )
  Bool                        m_bAdaptiveBaseModeFlag;                                     //slice_header_in_scalable_extension( )
  Bool                        m_bDefaultBaseModeFlag;                                        //slice_header_in_scalable_extension( )
  Bool                        m_bAdaptiveMotionPredictionFlag;                         //slice_header_in_scalable_extension( )
  Bool                        m_bDefaultMotionPredictionFlag;                            //slice_header_in_scalable_extension( )
  Bool                        m_bAdaptiveResidualPredictionFlag;                       //slice_header_in_scalable_extension( )
  Bool                        m_bDefaultResidualPredictionFlag;                          //slice_header_in_scalable_extension( )
  Bool                        m_bTCoeffLevelPredictionFlag;                                 //slice_header_in_scalable_extension( )
  UInt                        m_uiScanIdxStart;        //slice_header_in_scalable_extension( )
  UInt                        m_uiScanIdxStop;        //slice_header_in_scalable_extension( )
